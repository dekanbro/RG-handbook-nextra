...
- **Sesh Bot**: Use `!list` in Discord to view upcoming events. Sesh Bot also offers RSVP and reminder functions to keep meetings organized. Learn more [here](https://handbook.raidguild.org/discord-bots#sesh).
