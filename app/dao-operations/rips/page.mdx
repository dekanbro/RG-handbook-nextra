...
For RIP projects, we leverage [SmartInvoice](https://app.smartinvoice.xyz) from within [Dungeon Master](https://dm.raidguild.org). The recommended solution is to have [Ganggang](/dao-operations/dao-roles#ganggang---quality-assurance-group) be the client (or release address)
