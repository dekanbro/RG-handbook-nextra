...
### Quick Access Links
- [RaidGuild Figma Design System](https://www.figma.com/file/xha2APaLAJeXGaLhrWMhEO/RaidGuild-DSM-(RG-UI)?type=design&node-id=0%3A1&mode=design&t=pKFUSTHMd3A38pKS-1)
- [Storybook Components](https://raid-guild.github.io/design-system/?path=/story/)
...
1. Access the [Figma Design System file](https://www.figma.com/file/xha2APaLAJeXGaLhrWMhEO/RaidGuild-DSM-(RG-UI)?type=design&node-id=0%3A1&mode=design&t=pKFUSTHMd3A38pKS-1)
...
1. In Figma, go to the **Assets** panel and select the **Team Library** icon.
   ...
   ![Enable Library](https://github.com/raid-guild/handbook/assets/26507741/ce54d9bf-60fc-46af-a3f8-ebe64e53e97a)

2. From the pop-up, choose the **Raid Guild design library** and toggle it on to enable access in your file.

   ![Select Library](https://github.com/raid-guild/handbook/assets/26507741/0c4ebd0c-ced3-49ac-88b6-c4730fce76d6)
...
4. Go to **Assets** > **Team Library** icon > **Publish Library**.
   ...
   ![Publish Library](https://github.com/raid-guild/handbook/assets/26507741/8592ecc3-07b3-41e7-b640-7ae7243b5698)
